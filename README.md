...
Furthermore, Spring is well-known for being slow to start-up because it typically scans the entire byte code of your app
for its annotations. Of course, you can avoid that entirely by going down XML configuration hell - oh my!

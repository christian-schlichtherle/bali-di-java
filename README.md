...
The code generated by the annotation processor will forward any calls of this method to the method `Date get()` (3)
...
+ You can apply the [`@Lookup`](annotation/src/main/java/bali/Lookup.java) annotation to abstract, parameterless
